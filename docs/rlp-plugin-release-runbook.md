...
Completed pass records live in `docs/release-notes.md`.
...
- README, LICENSE, manifest, examples, and documentation links
...
- Tests pass on the final revision.
...
For each completed pass, append a short record to `docs/release-notes.md`:
